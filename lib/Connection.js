...
function Connection(configuration) {
	...
	// Options.
	this.options = {
		iceTransportsRelay: (configuration.iceTransports === 'relay'),
		iceTransportsNone: (configuration.iceTransports === 'none'),
		gatheringTimeoutAfterRelay: configuration.gatheringTimeoutAfterRelay
	};

	// Remove custom options from configuration.
	delete configuration.gatheringTimeoutAfterRelay;

	// Create a RTCPeerConnection.
	this.pc = new Adapter.RTCPeerConnection(configuration);
