...
function Connection(pcConfig, pcConstraints) {
	...
	// Remove custom options from pcConfig.
	delete this.pcConfig.gatheringTimeoutAfterRelay;

	// Create a RTCPeerConnection.
	this.pc = new Adapter.RTCPeerConnection(this.pcConfig, pcConstraints);
...
Connection.prototype.updateIce = function(pcConfig, pcConstraints) {
	debug('updateIce() | pcConfig: %o', pcConfig);

	Adapter.updateIce.call(this.pc, pcConfig, pcConstraints);

	// Update pcConfig if the above call did not fail.
